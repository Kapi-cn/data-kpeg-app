	...
	return (
		<Show when={!checkingAuth()}>
			<div class=":uno: relative flex items-center justify-center px-4 py-8 lg:px-8 lg:py-12 animate-fade-in min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(249,115,22,0.18),_transparent_30%),radial-gradient(circle_at_20%_20%,_rgba(56,189,248,0.12),_transparent_24%),radial-gradient(circle_at_bottom_right,_rgba(15,23,42,0.9),_transparent_35%),linear-gradient(135deg,_#020617_0%,_#0f172a_42%,_#111827_100%)]">
				...
				<div class=":uno: relative z-10 max-w-4xl lg:max-w-6xl rounded-3xl layout-light bg-[var(--surface)] grid grid-cols-1 md:grid-cols-12 overflow-hidden">
					{/* Left Branding Card */}
					<div class=":uno: hidden md:block md:col-span-5 relative layout-dark p-8 lg:p-10 bg-gradient-to-br from-slate-900 to-slate-800 overflow-hidden">
						<div class=":uno: relative z-10 space-y-8">
							<div class=":uno: flex items-center gap-3">
								...
								<div>
									<p
										aria-hidden="true"
										class=":uno: tracking-wider font-black text-2xl/5 tracking-wide text-[var(--title)]"
									>
										Kegiatan
									</p>
									<p
										aria-hidden="true"
										class=":uno: tracking-wider font-bold text-xl text-[var(--title)]"
									>
										Pegawai BPMPTP
									</p>
							...
							<div class=":uno: space-y-4 mt-12">
								...
								<p class=":uno: text-xs/4 lg:text-sm/5 text-[var(--text-muted)] text-justify">
									Untuk mencegah akses tanpa izin, pembuatan data kegiatan,
									penyuntingan, dan pengelolaan master pegawai memerlukan
									identifikasi akun yang terverifikasi.
								</p>
							</div>
							<div>
					...
					<div class=":uno: md:col-span-7 layout-light p-10 lg:p-12 space-y-6 overflow-hidden">
						<div>
							<h2 class=":uno: text-xl lg:text-2xl font-bold text-[var(--title)]">
								Masuk ke Aplikasi
							</h2>
						...
						<form onSubmit={handleLogin} class=":uno: space-y-4">
							<div>
								...
								<Show when={usernameErr()}>
									<p class=":uno: mt-1 ml-0.5 flex items-center gap-1 text-xs text-rose-600">
										<FiAlertCircle size={12} stroke-width={2} /> Username tidak
										boleh kosong
									</p>
								</Show>
							</div>
							<div>
								...
								<div class=":uno: relative">
									...
									>
										{showPassword() ? (
											<FiEye size={16} stroke-width={2} />
										) : (
											<FiEyeOff size={16} stroke-width={2} />
										)}
									</button>
								</div>
								<Show when={passwordErr()}>
									<p class=":uno: mt-1 ml-0.5 flex items-center gap-1 text-xs text-rose-600">
										<FiAlertCircle size={12} stroke-width={2} /> Password tidak
										boleh kosong
									</p>
								</Show>
							</div>
							<button
								type="submit"
								class=":uno: mt-10 flex items-center gap-3 font-bold justify-center px-3 py-2 lg:py-3 text-amber-50 w-full rounded-full bg-orange-400 transition-all duration-200 hover:scale-[1.02] active:scale-95"
							>
						...
						<div class=":uno: border-t border-[var(--border)]">
							<div class=":uno: p-4 bg-gradient-to-br from-orange-50/80 via-slate-50 to-amber-50/60 border border-orange-200/80 rounded-2xl mt-5 flex items-start gap-3">
								...
								<div class=":uno: space-y-1 text-xs">
									<h3 class=":uno: font-bold text-[var(--title)]">
										Mengalami Kendala Akses Login?
									</h3>
									<p class=":uno: font-medium text-[var(--text)]">
										Stuck? Hubungi administrator sistem IT untuk bantuan
										pemulihan kredensial, perbaikan akun, atau reset password
										login Anda.
									</p>
								</div>
							</div>
