          ...
          <ul class=':uno: flex flex-col space-y-4'>
            ...
            <li>
              <div class=':uno: grid grid-cols-2 gap-2'>
                <button class=':uno: border border-[var(--border)] flex text-[var(--text-muted)]/80 items-center gap-3 px-3 py-2.5 text-xs font-bold rounded-2xl transition-all ease-out duration-300 hover:(bg-[var(--surface-alt)]/50 text-white)'>
                  <div class=':uno: text-violet-500'>
                    <FiBell size={18} stroke-width={1.5} />
                  </div>
                  Pending
                </button>
                <button class=':uno: border border-[var(--border)] flex text-[var(--text-muted)]/80 items-center gap-3 px-3 py-2.5 text-xs font-bold rounded-2xl transition-all ease-out duration-300 hover:(bg-[var(--surface-alt)]/50 text-white)'>
                  <div class=':uno: text-green-500'>
